...
public class FromActivity extends ListActivity{
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		// TODO Auto-generated method stub
		 menu.setHeaderTitle("List Clicked");
		 menu.add(0, v.getId(), 0, "Yeah");
		...
		protected void onListItemClick(ListView l, View v, int position, long id) {
		    super.onListItemClick(l, v, position, id);
		      ...
		      Log.d("Country", code);
			   ...
			   editor.putString("from_country",country);
			   editor.putString("from_code",code);
			   editor.commit();
