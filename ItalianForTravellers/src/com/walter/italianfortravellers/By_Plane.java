...
public class By_Plane extends ListActivity {
	...
	// final EditText searchBox=(EditText) findViewById(R.id.searchBox);
	 ...
	 String teams[]={" Vorrei prenotare un volo per venerdì per Firenze. ","C'è la coincidenza per Roma? ","Quando parte il prossimo aereo per Napoli? ","Ci sono ancora posti liberi? ","Classe turistica. ","Prima classe. ","Quanto costa un volo andata e ritorno per Palermo? ","Quanto bagaglio è permesso? ","Quando devo essere là? ","Devo annullare/rimandere il mio volo. "};
