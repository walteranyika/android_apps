...
public class Health extends ListActivity {
	...
	// final EditText searchBox=(EditText) findViewById(R.id.searchBox);
	 ...
	 String teams[]={" Dove posso trovare un dottore? ","Dov'è l'ospedale più vicino? ","Dov'è la farmacia più vicina? ","Mi fa male qui. ","Ho la febbre. ","Mi gira la testa. ","Ho la nausea. ","Ho mal di stomaco. ","Ci vuole una ricetta per questa medicina? ","Ho preso il raffreddore. "};
