...
public class CalendarActivity extends ListActivity {
	...
	// final EditText searchBox=(EditText) findViewById(R.id.searchBox);
	 ...
	 String teams[]={"Ichi-gatsu","Ni-gatsu","San-gatsu","Shi-gatsu","Go-gatsu","Roku-gatsu","Shichi-gatsu","Hachi-gatsu","Ku-gatsu","Juu-gatsu","Juuichi-gatsu","Juuni-gatsu"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) 
		{
		      ...
		      switch(position)
	             ...
	             case 0:
                     //play
                     playMedia("months/jan.mp3");
                     //poppDialog(data[0]);
                     break;
                 case 1:
                     //play
                     playMedia("months/feb.mp3");
                      //poppDialog(data[1]);
                     break;
                 case 2:
                     //play
                     playMedia("months/march.mp3");
                      //poppDialog(data[2]);
                     break;
                 case 3:
                     playMedia("months/april.mp3");
                      //poppDialog(data[3]);
                     //play
                     break;
                 case 4:
                     //play
                     playMedia("months/may.mp3");
                      //poppDialog(data[4]);
                     break;
                 case 5:
                     //play
                     playMedia("months/june.mp3");
                      //poppDialog(data[5]);
                     break;
                 case 6:
                     //play
                     playMedia("months/july.mp3");
                      //poppDialog(data[6]);
                     break;
                 case 7:
                     //play
                     playMedia("months/augst.mp3");
                      //poppDialog(data[7]);
                     break;
                 case 8:
                     //play
                     playMedia("months/sept.mp3");
                      //poppDialog(data[8]);
                     break;
                 case 9:
                     //play
                     playMedia("months/oct.mp3");
                      //poppDialog(data[9]);
                     break;
                 case 10:
                     //play
                     playMedia("months/nov.mp3");
                      //poppDialog(data[10]);
                     break;
                 case 11:
                     //play
                     playMedia("months/dec.mp3");
                      //poppDialog(data[11]);
                     break;
