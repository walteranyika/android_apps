...
public class ColorsActivity extends ListActivity {
	...
	// final EditText searchBox=(EditText) findViewById(R.id.searchBox);
	 ...
	 String names[]={"Colors","Blue","Red","Brown","Orange","Grey","Yellow",
             "Light Green","Black","Green","Light Blue","Pink","Purple","While"};
	 
	 String teams[]={"Iro","Ao","Aka","Chairo","Daidaiiro","Haiiro","Kiiro",
             "Kimidori","Kuro","Midori","Mizuiro","Momoiro","Murasaki","Shiro"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) 
		{
		      ...
		      switch(position)
	             ...
	             case 0:
                     //play
                     playMedia("colors/iro.mp3");
                     //poppDialog(data[0]);
                     break;
                 case 1:
                     //play
                     playMedia("colors/ao.mp3");
                     //poppDialog(data[1]);
                     break;
                 case 2:
                     //play
                     playMedia("colors/aka.mp3");
                     //poppDialog(data[2]);
                     break;
                 case 3:
                     playMedia("colors/chairo.mp3");
                     //poppDialog(data[3]);
                     //play
                     break;
                 case 4:
                     //play
                     playMedia("colors/daidai.mp3");
                     //poppDialog(data[4]);
                     break;
                 case 5:
                     //play
                     playMedia("colors/haiiro.mp3");
                     //poppDialog(data[5]);
                     break;
                 case 6:
                     //play
                     playMedia("colors/kiiro.mp3");
                     //poppDialog(data[6]);
                     break;
                 case 7:
                     //play
                     playMedia("colors/kimidori.mp3");
                     //poppDialog(data[7]);
                     break;
                 case 8:
                     //play
                     playMedia("colors/kuro.mp3");
                     //poppDialog(data[8]);
                     break;
                 case 9:
                     //play
                     playMedia("colors/midori.mp3");
                     //poppDialog(data[9]);
                     break;
                 case 10:
                     //play
                     playMedia("colors/mizuiro.mp3");
                     //poppDialog(data[10]);
                     break;
                 case 11:
                     //play
                     playMedia("colors/momoiro.mp3");
                     //poppDialog(data[11]);
                     break;
                 case 12:
                     //play
                     playMedia("colors/murasaki.mp3");
                     //poppDialog(data[12]);
                     break;
                 case 13:
                     //play
                     playMedia("colors/shiro.mp3");
                     //poppDialog(data[13]);
                     break;
