...
public class DaysActivity extends ListActivity {
	...
	// final EditText searchBox=(EditText) findViewById(R.id.searchBox);
	 ...
	 String teams[]={"Nichiyoubi","Getsuyobi","Ka","Suiyoubi","Mokuyoubi","Kin","Doyoubi"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) 
		{
		      ...
		      switch(position)
	             ...
	             case 0:
                     //play
                     playMedia("days/nichiyoubi.mp3");
                     //poppDialog(data[0]);
                     break;
                 case 1:
                     //play
                     playMedia("days/getsuyoubi.mp3");
                     //poppDialog(data[1]);
                     break;
                 case 2:
                     //play
                     playMedia("days/ka.mp3");
                     //poppDialog(data[2]);
                     break;
                 case 3:
                     playMedia("days/suiyoubi.mp3");
                     //play
                     //poppDialog(data[3]);
                     break;
                 case 4:
                     //play
                     playMedia("days/mokuyoubi.mp3");
                     //poppDialog(data[4]);
                     break;
                 case 5:
                     //play
                     playMedia("days/kin.mp3");
                     //poppDialog(data[5]);
                     break;
                 case 6:
                     //play
                     playMedia("days/doyoubi.mp3");
                     //poppDialog(data[6]);
                     break;
