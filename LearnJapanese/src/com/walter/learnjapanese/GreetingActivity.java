...
public class GreetingActivity extends ListActivity {
	...
	// final EditText searchBox=(EditText) findViewById(R.id.searchBox);
	 ...
	 String names[]={"Good Morning","Good Afternoon","Good Evening","Good Night","Good Bye","See You Later","See You Tomorrow","How are You"};
	 
	 String teams[]={"Ohayou","Konnichiwa","Konbanwa","Oyasuminasai","Sayonara","Dewa mata","Mata ashita","Genki desu ka"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) 
		{
		      ...
		      switch(position)
	             ...
	             case 0:
                     //play
                     playMedia("greetings/ohayou.mp3");
                    // poppDialog("Ohayou");
                     break;
                 case 1:
                     //play
                     playMedia("greetings/konnichiwa.mp3");
                    // poppDialog("Konnichiwa");
                     break;
                 case 2:
                     //play
                     playMedia("greetings/konbanwa.mp3");
                    // poppDialog("Konbanwa");
                     break;
                 case 3:
                     //play
                     playMedia("greetings/oyasuminasai.mp3");
                    // poppDialog("Oyasuminasai");
                     break;
                 case 4:
                     playMedia("greetings/sayonara.mp3");
                    // poppDialog("Sayonara");
                     //play
                     break;
                 case 5:
                     //play
                     playMedia("greetings/dewamata.mp3");
                    // poppDialog("Dewamata");
                     break;
                 case 6:
                     //play
                     playMedia("greetings/mataashita.mp3");
                    // poppDialog("Mata shita");
                     break;
                 case 7:
                     //play
                     playMedia("greetings/genkidesuka.mp3");
                    // poppDialog("Genki Desu ka");
                     break;
