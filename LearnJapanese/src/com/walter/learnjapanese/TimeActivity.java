...
public class TimeActivity extends ListActivity {
	...
	// final EditText searchBox=(EditText) findViewById(R.id.searchBox);
	 ...
	 String names[]={"Three o'clock","Four o'clock","Five o'clock","Six o'clock","Seven o'clock","Eight o'clock", "Nine o'clock", "Ten o'clock","Eleven o'clock","Twelve o'clock"};
	 
	 String teams[]={"San-ji","Yo-ji","Go-ji","Roku-ji","Shichi-ji","Hachi-ji","Ku-ji","Juu-ji","Juuichi-ji","Juuni-ji"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) 
		{
		      ...
		      switch(position)
	             ...
	             case 0:
                     //play
                     playMedia("time/sanji.mp3");
                    // poppDialog(data[0]);
                     break;
                 case 1:
                     //play
                     playMedia("time/yoji.mp3");
                    // poppDialog(data[1]);
                     break;
                 case 2:
                     //play
                     playMedia("time/goji.mp3");
                    // poppDialog(data[2]);
                     break;
                 case 3:
                     playMedia("time/rokuji.mp3");
                    // poppDialog(data[3]);
                     //play
                     break;
                 case 4:
                     //play
                     playMedia("time/shichiji.mp3");
                    // poppDialog(data[4]);
                     break;
                 case 5:
                     //play
                     playMedia("time/hachiji.mp3");
                    // poppDialog(data[5]);
                     break;
                 case 6:
                     //play
                     playMedia("time/kuji.mp3");
                    // poppDialog(data[6]);
                     break;
                 case 7:
                     //play
                     playMedia("time/juuji.mp3");
                    // poppDialog(data[7]);
                     break;
                 case 8:
                     //play
                     playMedia("time/juuichiji.mp3");
                    // poppDialog(data[8]);
                     break;
                 case 9:
                     //play
                     playMedia("time/juuniji.mp3");
                    // poppDialog(data[9]);
                     break;
