...
public class Favourites  extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#00a8ec")));
		...
		{
			Toast.makeText(getApplicationContext(), "No items i your favourites", Toast.LENGTH_SHORT).show();
		}
